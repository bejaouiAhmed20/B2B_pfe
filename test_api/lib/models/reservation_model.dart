...
class Reservation {
  ...
  factory Reservation.fromJson(Map<String, dynamic> json) {
    return Reservation(
      ...
      allocatedSeats: json['allocatedSeats'] != null 
          ? List<AllocatedSeat>.from(
              json['allocatedSeats'].map((seat) => AllocatedSeat.fromJson(seat))
            )
          : [],
    );
  }
